...
. Optional: Überwachen Sie den Betriebsfortschritt, indem Sie unten im Fenster auf *Letzte Aufgaben* oder auf dem Dashboard *Job Monitor* klicken, um weitere Informationen zu erhalten.
.Result
