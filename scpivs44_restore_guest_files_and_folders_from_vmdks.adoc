...
+
Diese Option ist erforderlich, wenn Sie benachrichtigt werden möchten, wenn der Vorgang zum Anhängen abgeschlossen ist und das virtuelle Laufwerk verfügbar ist. Die Benachrichtigungs-E-Mail enthält den Namen des virtuellen Laufwerks, den VM-Namen und den neu zugewiesenen Laufwerksbuchstaben für die VMDK.
...
| Wiederherstellen des Pfads | Geben Sie den UNC-Freigabepfad zum Gast ein, auf dem die ausgewählten Dateien wiederhergestellt werden.
IPv4-Beispiel: `\\10.60.136.65\c$`
Beispiel für IPv6: `\\fd20-8b1e-b255-832e--61.ipv6-literal.net\C\restore` 


| Wenn Originaldatei(en)
Vorliegen  a| 
...
| Trennen Sie Die Verbindung Zum Gast
Sitzung nach
Erfolgreiche Wiederherstellung | Wählen Sie diese Option aus, wenn die Wiederherstellungssitzung der Gastdatei gelöscht werden soll, wenn der Wiederherstellungsvorgang abgeschlossen ist. 
|===
