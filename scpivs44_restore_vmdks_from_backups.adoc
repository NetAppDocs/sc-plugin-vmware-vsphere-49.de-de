...
| Den ursprünglichen Datenspeicher verwendet | Wählen Sie in der Dropdown-Liste * bestimmtes Laufwerk* aus und klicken Sie dann auf *Weiter*.
In der Tabelle Datastore Selection können Sie beliebige VMDKs auswählen oder deren Auswahl aufheben. 
